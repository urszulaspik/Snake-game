...
class LevelButton(arcade.gui.UIFlatButton):
    '''
    Class with button to change the view
    for view with Level 1 or Level 2
    '''
    ...
    def on_click(self):
        ...
        button to change the view to the view of the indicated level
        '''
...
class ResultButton(arcade.gui.UIFlatButton):
    ...
    def on_click(self):
        """
        Called when user lets off button,
        change the view for result of the indicated level
        """
