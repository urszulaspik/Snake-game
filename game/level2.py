...
from game.settings import GAME_WIDTH, GAME_HEIGHT, APPLE, MOVEMENT_SPEED, BACKGROUNDS, HEART, SCREEN_HEIGHT, SCREEN_WIDTH, SOUNDS


class MyGame2(arcade.View):
    """
    Class with view with level 2 of the game
    """
    ...
    def on_update(self, delta_time):
        ...
        if self.black_apple.new_apple_ate(GAME_WIDTH, GAME_HEIGHT, MOVEMENT_SPEED, self.snake.center_x,
                                          self.snake.center_y, self.snake.snake_body(), self.all):
            self.heart_lose()
